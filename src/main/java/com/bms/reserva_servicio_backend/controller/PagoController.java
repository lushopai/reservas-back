...
public class PagoController {
        ...
        public ResponseEntity<SuccessResponse<PagoResponse>> procesarPagoReserva(
                ...
                // Validar que la reserva esté en estado PENDIENTE_PAGO, PENDIENTE o CONFIRMADA
                if (reserva.getEstado() != EstadoReserva.PENDIENTE_PAGO &&
                        ...
                        return ResponseEntity.badRequest()
                                        .body(SuccessResponse.of(null,
                                                        "La reserva no puede ser pagada en su estado actual: "
                ...
                // Actualizar estado de reserva a CONFIRMADA si estaba PENDIENTE_PAGO o
                // PENDIENTE
                if (reserva.getEstado() == EstadoReserva.PENDIENTE_PAGO
                                || reserva.getEstado() == EstadoReserva.PENDIENTE) {
        ...
        public ResponseEntity<SuccessResponse<PagoResponse>> procesarPagoPaquete(
                ...
                if (request.getMonto().compareTo(paquete.getPrecioFinal()) != 0) {
                        return ResponseEntity.badRequest()
                                        .body(SuccessResponse.of(null,
                                                        "El monto no coincide con el total del paquete"));
                }
                ...
                if (paquete.getEstado() != EstadoPaquete.BORRADOR &&
                        ...
                        return ResponseEntity.badRequest()
                                        .body(SuccessResponse.of(null,
                                                        "El paquete no puede ser pagado en su estado actual: "
        ...
        private PagoResponse mapToPagoResponse(Pagos pago) {
                return PagoResponse.builder()
                                ...
                                .tipoReserva(pago.getReserva() != null && pago.getReserva().getTipoReserva() != null
                                                ? pago.getReserva().getTipoReserva().name()
                                                : null)
                                .build();
        }
        ...
        private PagoResponse mapToPagoResponsePaquete(Pagos pago) {
                return PagoResponse.builder()
                                .id(pago.getId())
                                .reservaId(pago.getPaquete() != null ? pago.getPaquete().getId() : null) // Usar
                                                                                                         // reservaId
                                                                                                         // para
                                                                                                         // consistencia
                                .monto(pago.getMonto())
